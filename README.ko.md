...
- **저장소 접근:** 로그인한 계정의 비공개 저장소가 GitHub App 설치의 접근 범위에 포함되지 않으면, 해당 소유자·저장소에 대한 App 접근을 설정하도록 안내합니다.
- **조직:** 비공개 조직 저장소를 읽으려면 조직 소유자가 GitHub App을 설치하거나 승인해야 할 수 있습니다.
- **여러 계정:** 개인 계정과 업무 계정을 함께 추가할 수 있습니다. 확장 프로그램이 각 저장소에 맞는 계정을 선택합니다.
