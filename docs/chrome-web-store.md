...
- The pull-list screenshots use a deterministic fictional GitHub-style fixture (`Northstar/atlas-ui`) with generated PR titles, authors, reviewer states, and synthetic avatar images. Do not create live dummy PRs for store screenshots.
...
6. Refresh screenshots so they show reviewer chips on GitHub pull request lists only, using the generated fictional fixture rather than live dummy PRs.
