...
[查看 30 秒产品介绍](https://hon454.github.io/github-pulls-show-reviewers/)。
...
- **仓库访问：** 如果已登录账号的私有仓库不在 GitHub App 安装的访问范围内，扩展会提示你为相应的所有者或仓库配置 App 访问权限。
- **组织：** 读取组织的私有仓库前，可能需要组织所有者安装或批准 GitHub App。
- **多个账号：** 可以同时添加个人和工作账号，扩展会为每个仓库选择匹配的账号。
